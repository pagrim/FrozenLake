...
#     for i in range(5):
#         fql = FrozenQLearner(episodes=500, alpha=0.1, gamma=gamma_test, epsilon_start=0.9, df1=0.9, df2=0.99)
#         fql.execute(log_level=30, write_file=True, file_desc='experiment_gamma_%2.1f_%d' % (gamma_test,i), in_memory=False)
#
...
#     fsl.execute(log_level=30,write_file=True,file_desc='experiment_SARSA_lambda_{:4.2f}_normsum_full'.format(test_lambda),
